...
const S = {
  ...
  card: { background: "var(--card)", border: "1px solid var(--border)", borderRadius: 18, overflow: "hidden", display: "flex", flexDirection: "column", boxShadow: "var(--card-shadow)", height: 400 },
  thumbWrap: { position: "relative", height: 195, flexShrink: 0, background: "#e8edf2" },
